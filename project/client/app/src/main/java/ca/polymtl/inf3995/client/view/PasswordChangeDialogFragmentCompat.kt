...
import ca.polymtl.inf3995.client.controller.event.PasswordChangeRequestEvent
...
class PasswordChangeDialogFragmentCompat: PreferenceDialogFragmentCompat() {
    ...
    override fun onBindDialogView(view: View?) {
        ...
        newPassword
            .setImeActionLabel(getString(R.string.change_password_button_submit), EditorInfo.IME_ACTION_DONE)
