...
import ca.polymtl.inf3995.client.view.BlackListActivity
import ca.polymtl.inf3995.client.view.StatisticsActivity
import java.util.*
...
class AppStateService(private val appCtx: Context): Observable() {
    ...
    private val states: Map<State, AppState> = mapOf(
        ...
        State.Admin to object: AppState {
