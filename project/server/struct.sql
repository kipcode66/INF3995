...
CREATE TABLE songs (title VARCHAR(256), artist VARCHAR(256), user_id INTEGER NOT NULL, duration INTEGER, path VARCHAR(256), song_order INTEGER, deleted_by_admin INTEGER, timestamp REAL);
