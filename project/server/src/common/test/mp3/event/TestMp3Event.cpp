...
public:
    ...
    virtual void acceptVisitor(AbstractMp3EventVisitor& visitor) { throw std::runtime_error("TestMp3Event is a test class and does not support accepting a visitor"); }
};
